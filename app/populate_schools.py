...
# 3. Example usage: populate schools
schools_data = [
    {"name": "Abjuration", "abbreviation": "ABJ"},
    {"name": "Conjuration", "abbreviation": "CON"},
    {"name": "Divination", "abbreviation": "DIV"},
    {"name": "Enchantment", "abbreviation": "ENC"},
    {"name": "Evocation", "abbreviation": "EVO"},
    {"name": "Illusion", "abbreviation": "ILL"},
    {"name": "Necromancy", "abbreviation": "NEC"},
    {"name": "Transmutation", "abbreviation": "TRA"},
]

populate_table(session, School, schools_data, unique_field="name")
